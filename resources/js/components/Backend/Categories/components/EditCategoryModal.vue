<template>
    <div class="edit-category-modal" @click="this.$emit('show', false)">
        <div @click.stop class="edit-category-item">
            <div class="row">
                <div class="col-9">
            ...
            <div class="row">
                <input type="text" name="name_ua" placeholder="Українська" v-model="this.$store.getters.getCategoryById.name_ua" v-if="this.lang.name.active === 'name_ua'">
                <input type="text" name="name_en" placeholder="English" v-model="this.$store.getters.getCategoryById.name_en" v-if="this.lang.name.active === 'name_en'">
            </div>
            <div class="row pt-2 mb-2 p-0">
                <label for="">Слаг</label>
                <input type="text" placeholder="example-slug" v-model="this.$store.getters.getCategoryById.slug">
            </div>
            <div class="row">
                <div class="col-1 mt-2">
                    <input type="checkbox" v-model="this.$store.getters.getCategoryById.parent_id">
                </div>
                <div class="col mt-1">
            ...
            <div class="row" v-if="this.category.parent_id !== true">
                <div class="col pt-2 pb-2">
                    ...
                    <div class="row">
                        <select name="categories" id="" v-model="this.$store.getters.getCategoryById.parent_id">
            ...
            <div class="row">
                <div class="col d-flex justify-content-end align-items-end mt-2 p-0">
                    <button @click="edit">Змінити</button>
                </div>
            </div>
        </div>
    </div>
